...
void setup()
{
	...
	ATS_PrintTestStatus("1.  Adding a constant integer to a string:",
			    strcmp(charResult, "stringThree = 123") == 0);

	// adding a constant long interger to a string:
	stringThree = stringOne + 123456789;
	stringThree.toCharArray(charResult, sizeof(charResult));

	ATS_PrintTestStatus("2.  Adding a constant long interger to a string",
			    strcmp(charResult, "stringThree = 123456789") == 0);

	// adding a constant character to a string:
	stringThree = stringOne + 'A';
	stringThree.toCharArray(charResult, sizeof(charResult));

	ATS_PrintTestStatus("3.  Adding a constant character to a string",
			    strcmp(charResult, "stringThree = A") == 0);

	// adding a constant string to a string:
	stringThree = stringOne + "abc";
	stringThree.toCharArray(charResult, sizeof(charResult));

	ATS_PrintTestStatus("4.  Adding a constant string variable to a string",
			    strcmp(charResult, "stringThree = abc") == 0);

	//"5. Adding a constant long interger to a string"
	stringThree = stringOne + stringTwo;
	stringThree.toCharArray(charResult, sizeof(charResult));

	ATS_PrintTestStatus("5.  Adding a constant long interger to a string",
			    strcmp(charResult,
				   "stringThree = this string") == 0);
	...
	ATS_PrintTestStatus("7.  Two strings not equal",
			    stringOne != stringTwo);
	...
	stringOne = "this";
	stringTwo = "this";
	ATS_PrintTestStatus("9.  Equals() method equals",
			    stringOne.equals(stringTwo));

	// you can also use not equals() to see if two strings are not the same:
	stringOne = String("This");
	stringTwo = String("this");
	ATS_PrintTestStatus("10. Not equals() method equals",
			    !stringOne.equals(stringTwo));

	// or perhaps you want to ignore case:
	ATS_PrintTestStatus("11. EqualsIgnoreCase() method equals",
...
// in Arduino 1.0.  Only run this test on older version, or if using Teensy
	...
	int numberOne = 1;
	ATS_PrintTestStatus
	    ("12. A numeric string compared to the number it represents",
	     stringOne == numberOne);
#endif
	...
	stringOne = "2";
	stringTwo = "1";
	ATS_PrintTestStatus("13. Two numeric strings compared",
			    stringOne >= stringTwo);
	...
	ATS_PrintTestStatus("18. compareTo() compare strings",
 ...
 */
	...
	stringOne += stringTwo;
	ATS_PrintTestStatus("21. Adding string to string += ",
			    stringOne.equals("Sensor value"));
	ATS_PrintTestStatus
	    ("22. The compareTo()  compare strings with appended integers",
	     stringOne.compareTo(stringTwo) < 0);

	stringOne = "The quick brown fox";
	ATS_PrintTestStatus("23. Substring ", stringOne.substring(0, 1) == "T");
	ATS_PrintTestStatus("24. Substring ",
			    stringOne.substring(0, 3) == "The");
	ATS_PrintTestStatus("25. Substring ",
			    stringOne.substring(4, 9) == "quick");
	ATS_PrintTestStatus("26. Substring ",
			    stringOne.substring(10, 15) == "brown");
	ATS_PrintTestStatus("27. Substring ",
			    stringOne.substring(16, 19) == "fox");
	ATS_PrintTestStatus("28. Substring ",
			    stringOne.substring(18, 19) == "x");
	ATS_PrintTestStatus("29. Substring ",
			    stringOne.substring(0, 19) == stringOne);

	stringOne =
	    "<p>Lorem ipsum dolor sit amet</p><p>Ipsem</p><p>Quod</p><p>";
	int i;
	...
	ATS_PrintTestStatus("45. replace",
			    stringOne == "zero 12345 one 12345 two");
	...
	ATS_PrintTestStatus("52. replace",
			    stringOne == "123456 one 123456 two");
	stringOne = "zero test one test two";
	stringOne.replace("test", "1234567");
	ATS_PrintTestStatus("53. replace",
			    stringOne == "zero 1234567 one 1234567 two");
	stringOne = "zero test one test";
	stringOne.replace("test", "12345678");
	ATS_PrintTestStatus("54. replace",
			    stringOne == "zero 12345678 one 12345678");
	stringOne = "zero test one test";
	stringOne.replace('e', 'X');
	ATS_PrintTestStatus("55. replace char",
			    stringOne == "zXro tXst onX tXst");
#else
	stringOne = "test one test";
	ATS_PrintTestStatus("43. replace",
			    stringOne.replace("test",
					      "1234") == "1234 one 1234");
	stringOne = "test one test two";
	ATS_PrintTestStatus("44. replace",
			    stringOne.replace("test",
					      "1234") == "1234 one 1234 two");
	stringOne = "zero test one test two";
	ATS_PrintTestStatus("45. replace",
			    stringOne.replace("test",
					      "12345") ==
			    "zero 12345 one 12345 two");
	stringOne = "zero test one test";
	ATS_PrintTestStatus("46. replace",
			    stringOne.replace("test",
					      "1234") == "zero 1234 one 1234");
	stringOne = "test one test";
	ATS_PrintTestStatus("47. replace",
			    stringOne.replace("test", "123") == "123 one 123");
	stringOne = "test one test two";
	ATS_PrintTestStatus("48. replace",
			    stringOne.replace("test",
					      "123") == "123 one 123 two");
	stringOne = "zero test one test two";
	ATS_PrintTestStatus("49. replace",
			    stringOne.replace("test",
					      "12") == "zero 12 one 12 two");
	stringOne = "zero test one test";
	ATS_PrintTestStatus("50. replace",
			    stringOne.replace("test", "1") == "zero 1 one 1");
	stringOne = "test one test";
	ATS_PrintTestStatus("51. replace",
			    stringOne.replace("test",
					      "12345") == "12345 one 12345");
	stringOne = "test one test two";
	ATS_PrintTestStatus("52. replace",
			    stringOne.replace("test",
					      "123456") ==
			    "123456 one 123456 two");
	stringOne = "zero test one test two";
	ATS_PrintTestStatus("53. replace",
			    stringOne.replace("test",
					      "1234567") ==
			    "zero 1234567 one 1234567 two");
	stringOne = "zero test one test";
	ATS_PrintTestStatus("54. replace",
			    stringOne.replace("test",
					      "12345678") ==
			    "zero 12345678 one 12345678");
	stringOne = "zero test one test";
	ATS_PrintTestStatus("55. replace char",
			    stringOne.replace('e',
					      'X') == "zXro tXst onX tXst");
#endif

	stringOne = "Zero";
	stringTwo = "oNe";
	ATS_PrintTestStatus("56. add",
			    stringOne + "124" + stringTwo + 5678 ==
			    "Zero124oNe5678");
#if ARDUINO >= 100
...
#else
	ATS_PrintTestStatus("57. toUpperCase",
			    stringOne.toUpperCase() == "ZERO");
	ATS_PrintTestStatus("58. toLowerCase",
			    stringTwo.toLowerCase() == "one");
#endif
	stringOne = "-1234567";
...
#define F(s) (s)
	...
	i = -25000;
	ATS_PrintTestStatus("84. concat",
			    stringOne + i == F("u572h-32768-32768-25000"));
	...
	ATS_PrintTestStatus("88. concat",
			    stringOne + i == F("5u1klj241732417324173"));
	...
	ATS_PrintTestStatus("92. concat",
			    stringOne + u == F("i8skjm651906519065190"));
	...
	stringOne += n;
	ATS_PrintTestStatus("95. append",
			    stringOne == F("ywh-91093847-91093847"));
	ATS_PrintTestStatus("96. concat",
			    stringOne + n ==
			    F("ywh-91093847-91093847-91093847"));
	ATS_PrintTestStatus("97. append",
			    stringOne == F("ywh-91093847-91093847"));
	...
	un -= 4;
	stringOne += un;
	ATS_PrintTestStatus("99. append",
			    stringOne == F("iu42949614794294961475"));
	ATS_PrintTestStatus("100. concat",
			    stringOne + un ==
			    F("iu429496147942949614754294961475"));
	ATS_PrintTestStatus("101. append",
			    stringOne == F("iu42949614794294961475"));
	...
	ATS_PrintTestStatus("107. toCharArray",
			    strcmp_P(charResult, PSTR("Now i")) == 0);
...
// unless using Teensy.
	...
	ATS_PrintTestStatus("108. toCharArray",
			    strcmp_P(charResult, PSTR("he time f")) == 0);

	stringOne.toCharArray(charResult, sizeof(charResult), 25);
	ATS_PrintTestStatus("109. toCharArray",
			    strcmp_P(charResult, PSTR("ood men")) == 0);

	stringOne.getBytes((unsigned char *)charResult, 6);
	ATS_PrintTestStatus("110. getBytes",
			    strcmp_P(charResult, PSTR("Now i")) == 0);

	stringOne.getBytes((unsigned char *)charResult, 10, 8);
	ATS_PrintTestStatus("111. getBytes",
			    strcmp_P(charResult, PSTR("he time f")) == 0);

	stringOne.getBytes((unsigned char *)charResult, sizeof(charResult), 25);
	ATS_PrintTestStatus("112. getBytes",
			    strcmp_P(charResult, PSTR("ood men")) == 0);

	stringOne.toCharArray(charResult, sizeof(charResult), 100);
	ATS_PrintTestStatus("113. toCharArray",
			    strcmp_P(charResult, PSTR("")) == 0);
#endif
	...
	ATS_PrintTestStatus("119. operator [] write",
			    stringOne == F("now is the Sime for all good_men"));
	stringOne.toCharArray(charResult, sizeof(charResult));
	ATS_PrintTestStatus("120. operator [] write",
			    strcmp_P(charResult,
				     PSTR("now is the Sime for all good_men"))
			    == 0);

	stringOne[32] = '.';	// should not write over null term

	ATS_PrintTestStatus("121. operator [] write",
			    stringOne == F("now is the Sime for all good_men"));
	stringOne.toCharArray(charResult, sizeof(charResult));
	ATS_PrintTestStatus("122. operator [] write",
			    strcmp_P(charResult,
				     PSTR("now is the Sime for all good_men"))
			    == 0);
	...
	ATS_PrintTestStatus("123. operator [] write",
			    stringOne == F("now is the Sime for all good_men"));
	stringOne.toCharArray(charResult, sizeof(charResult));
	ATS_PrintTestStatus("124. operator [] write",
			    strcmp_P(charResult,
				     PSTR("now is the Sime for all good_men"))
			    == 0);
