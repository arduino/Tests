...
void setup()
{
	...
	ATS_PrintTestStatus("1. Add integer to string:",
	...
	ATS_PrintTestStatus("2. Add long to string",
	...
	ATS_PrintTestStatus("3. Add char",
	...
	ATS_PrintTestStatus("4. Add string to string",
	...
	ATS_PrintTestStatus("5. Add long",
			    strcmp(charResult,
	...
	stringOne = "This";
	stringTwo = "this";
	ATS_PrintTestStatus("8. not equal (case matters)",
			    stringOne != stringTwo);
	...
	ATS_PrintTestStatus("11. EqualsIgnoreCase()",
...
// in Arduino 1.0.  Only run this test on older version, or if using Teensy
	...
	stringOne = "1";
	int numberOne = 1;
	ATS_PrintTestStatus("12. A numeric string compared to number",
			    stringOne == numberOne);
#endif
	...
	ATS_PrintTestStatus("18. compareTo()",
...
*/
	...
	ATS_PrintTestStatus("22. The compareTo() appended int",
			    stringOne.compareTo(stringTwo) < 0);
